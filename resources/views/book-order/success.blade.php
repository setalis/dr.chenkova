<x-layouts.main>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Заказ успешно оформлен!</h1>
            <p class="text-gray-600 dark:text-gray-400">Спасибо за ваш заказ. Мы свяжемся с вами в ближайшее время.</p>
        </div>

        @if(isset($order))
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Данные заказа:</h2>
                <div class="space-y-3">
                    @if(!empty($order['name']))
                    ...
                    @if(!empty($order['messenger']))
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Мессенджер:</span>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white font-medium">{{ $order['product_name'] ?? 'Бумажная книга' }}</span>
                    </div>
                    <div class="flex justify-between">
