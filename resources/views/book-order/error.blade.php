<x-layouts.main>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Произошла ошибка</h1>
            <p class="text-gray-600 dark:text-gray-400">{{ $message ?? 'Произошла непредвиденная ошибка. Пожалуйста, попробуйте позже.' }}</p>
        </div>
