<x-layouts.main>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400">Thank you for your order. We will contact you shortly.</p>
        </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div class="space-y-3">
                    ...
                    @if(!empty($order['messenger']))
                        <div class="flex justify-between">
                            <span class="text-gray-600 dark:text-gray-400">Messenger:</span>
                    ...
                    @if(!empty($order['country']) || !empty($order['city']) || !empty($order['address_1']))
                        <div class="space-y-2">
                            <div class="text-gray-600 dark:text-gray-400 font-semibold mb-2">Delivery address:</div>
                            <div class="pl-4 space-y-1">
                                ...
                                @if(!empty($order['address_1']))
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Address 1:</span>
                                        <span class="text-gray-900 dark:text-white font-medium">{{ $order['address_1'] }}</span>
                                    </div>
                                @endif
                                @if(!empty($order['address_2']))
                                    <div class="flex justify-between">
                                        <span class="text-gray-600 dark:text-gray-400">Address 2:</span>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white font-medium">{{ $order['product_name'] ?? 'Print book' }}</span>
                    </div>
                    <div class="flex justify-between">
