<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Замовлення бумажної книги</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
        Ви купуєте друковану версію книги.

        Доставка по Грузії — безкоштовна.

        <p class="text-gray-700 dark:text-gray-300 mb-6">
        Доставка за межі Грузії розраховується індивідуально в залежності від країни та способу доставки.
        </p>
        <p class="text-gray-700 dark:text-gray-300 mb-6">
            Будь ласка, вкажіть ваш адресу в формі замовлення — після оформлення ми зв'яжемося з вами і уточнимо вартість міжнародної доставки.
        </p>
        <p class="text-gray-700 dark:text-gray-300 mb-6">
        Приблизна вартість доставки до відділення: 
        
        <ul>
            <li>Польща - 7-12€</li>
            <li>Німеччина  - 20-23€</li>
            <li>Іспанія - 4-6€</li>
            <li>Україна - 10€</li>
        </ul>
        </p>
        ...
        <form action="{{ route_locale('book-order.store') }}" method="POST" 
            ...
            <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Месенджер <span class="text-red-500">*</span>
                </label>
                <div class="space-y-2">
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    <label for="address_1" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Адреса 1 <span class="text-red-500">*</span>
                    </label>
                    <input type="text" 
                           name="address_1" 
                           id="address_1" 
                ...
                <div class="mb-4">
                    <label for="zip" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Індекс (ZIP) <span class="text-red-500">*</span>
                    </label>
                    <input type="text" 
                           name="zip" 
                           id="zip" 
