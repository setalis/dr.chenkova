<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Order an e-book</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            You are purchasing the electronic version of the book in 4 formats: EPUB, PDF, MOBI, and FB2.
        </p>
