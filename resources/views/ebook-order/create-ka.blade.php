<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">ელექტრონული წიგნის შეკვეთა</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            თქვენ ყიდულობთ წიგნის ელექტრონულ ვერსიას 4 ფორმატში: EPUB, PDF, MOBI და FB2.
        </p>

        <p class="text-gray-700 dark:text-gray-300 mb-6 font-semibold">
            წარმატებული გადახდის შემდეგ წიგნის ფაილები გაიგზავნება თქვენ მიერ მითითებულ email მისამართზე.
        </p>
