<x-layouts.main>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 dark:text-gray-400">Дякуємо за покупку. Файли електронної книги надіслані на вашу email адресу.</p>
        </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white font-medium">{{ $order['product_name'] ?? 'Електронна книга' }}</span>
                    </div>
                    <div class="flex justify-between">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4 mb-6">
            <p class="text-sm text-blue-800 dark:text-blue-200">
                <strong>Перевірте вашу пошту!</strong> Файли книги у форматах EPUB, PDF, MOBI та FB2 надіслані на вказану email адресу.
            </p>
        </div>
