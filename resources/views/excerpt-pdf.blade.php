...
@endpush
    <div class="bg-gradient-to-r from-indigo-500/20 from-10% via-50% to-emerald-500/20 to-90% min-h-screen h-full pb-8 pt-20 px-4">
        ...
        <div class="container max-w-5xl mx-auto px-8 bg-white rounded-2xl py-6 gap-6">
            <div class="mb-6">
                <h1 class="text-4xl font-black uppercase text-center text-[#4BAE37] mb-4">Отрывок из книги</h1>
                <p class="text-lg text-gray-700 text-center">Предварительный просмотр книги "Кожа на всю жизнь"</p>
            </div>
