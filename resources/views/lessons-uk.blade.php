<x-layouts.main>
    ...
    <div class="bg-gradient-to-r from-indigo-500/20 from-10% via-50% to-emerald-500/20 to-90% min-h-screen flex flex-col">
        <div class="container max-w-7xl mx-auto px-4 pt-28">
            <h1 class="md:text-3xl text-2xl font-black uppercase text-center text-[#4BAE37] mb-6">Індивідуальне навчання</h1>
            <p class="md:text-lg text-base text-gray-700 mb-6">Формат для спеціалістів, орієнтованих на глибоке розуміння, клінічну логіку та персоналізовані стратегії ведення пацієнтів</p>
        </div>
            ...
            <div class="columns-1 md:columns-2 gap-8 mb-12">
                <div class="break-inside-avoid mb-8">
                    <div class="bg-white rounded-lg md:p-6 p-4 shadow-sm">
                        ...
                        <div class="md:px-10 px-2">
                            <h1 class="text-xl font-bold uppercase text-center text-[#575757] mb-6">Програма очного навчання №1</h1>
                            <p class="text-lg text-gray-700 mb-6">У цьому курсі ви вивчите:</p>
                            ...
                            <div class="flex flex-row justify-start items-center mb-6 gap-4">
                                <p class="text-lg font-bold text-gray-700 mb-6">Вартість курсу:</p>
                ...
                <div class="break-inside-avoid mb-8">
                    <div class="bg-white rounded-lg p-6 shadow-sm text-gray-700">
                        ...
                        <div class="md:px-10 px-2">
                            <h1 class="text-xl font-bold uppercase text-center text-[#575757] mb-6">Програма очного навчання №2</h1>
                            <p class="text-lg text-gray-700 mb-6">У цьому курсі ви дізнаєтеся:</p>
                            <ul class="list-disc list-inside text-base text-gray-700 mb-6">
                ...
                <div class="break-inside-avoid mb-8">
                    <div class="bg-white rounded-lg p-6 shadow-sm text-gray-700">
                        ...
                        <div class="md:px-10 px-2">
                            <h1 class="text-xl font-bold uppercase text-center text-[#575757] mb-6">PLA — крізь призму діагностики механізму втрати колагену</h1>
                            <p class="text-lg text-gray-700 mb-6">У цьому курсі ви дізнаєтеся:</p>
                            <ul class="list-disc list-inside text-base text-gray-700 mb-6">
                                <li>Фізіологія старіння</li>
                                <li>Епігенетика старіння</li>
                                <li>Діагноз</li>
                                <li>Що таке полімолочна кислота</li>
                                <li>Класифікація та механізм дії PLA</li>
                                <li>Протоколи роботи з різними формами (спец протоколи по різних виробниках)</li>
                                <li>Ускладнення</li>
                            </ul>
                            <div class="flex flex-col md:flex-row justify-start items-center mb-6 gap-4">
                                <div class="flex flex-col md:items-start items-center text-center md:text-left">
                                    <p class="text-lg font-bold text-gray-700">Вартість 1 дня:</p>
                                    <p class="text-base font-normal text-gray-700 md:mb-6 mb-3">Теорія + відпрацювання (1 модель)</p>
                                </div>
                                <button onclick="openModal()" class="bg-[#4BAE37] hover:bg-[#3c952a] text-white text-2xl px-16 py-3 rounded-md mx-auto block uppercase font-bold cursor-pointer mb-6">
                                €1300
                                </button>
                            ...
                            <div class="flex flex-col md:flex-row justify-start items-center mb-6 gap-4">
                                <div class="flex flex-col md:items-start items-center md:text-left text-center">
                                    <p class="text-lg font-bold text-gray-700 mb-3">Вартість 2 днів:</p>
                                    <p class="text-base font-normal text-gray-700 mb-1">1 день - теорія + постановка руки канюля</p>
                                    <p class="text-base font-normal text-gray-700 mb-6">2 день - відпрацювання 3-4 моделі</p>
                                </div>
                                <button onclick="openModal()" class="bg-[#4BAE37] hover:bg-[#3c952a] text-white text-2xl px-16 py-3 rounded-md mx-auto block uppercase font-bold cursor-pointer mb-6">
                                €2500
                                </button>
