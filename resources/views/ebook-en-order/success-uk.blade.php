<x-layouts.main>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Оплата успішна!</h1>
            <p class="text-gray-600 dark:text-gray-400">Дякуємо за покупку. Файли англійської електронної книги надіслано на вашу email адресу.</p>
        </div>

        @if(isset($order))
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mb-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Інформація про замовлення:</h2>
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-gray-900 dark:text-white font-medium">{{ $order['product_name'] ?? 'Електронна книга (English)' }}</span>
                    </div>
                    <div class="flex justify-between">
        ...
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4 mb-6">
            <p class="text-sm text-blue-800 dark:text-blue-200">
                <strong>Перевірте вашу пошту!</strong> Файли книги у форматах EPUB та KPF надіслано на вказану email адресу.
            </p>
        </div>
