<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Заказ английской электронной книги</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            Вы покупаете английскую электронную версию книги «Skin for Life» в 2 форматах: EPUB и KPF.
        </p>

        <p class="text-gray-700 dark:text-gray-300 mb-6 font-semibold">
            После успешной оплаты файлы книги будут отправлены на указанный вами email адрес.
        </p>
