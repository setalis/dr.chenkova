<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Order the English e-book</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            You are purchasing the English electronic version of «Skin for Life» in 2 formats: EPUB and KPF.
        </p>

        <p class="text-gray-700 dark:text-gray-300 mb-6 font-semibold">
            After a successful payment, the book files will be sent to the email address you provide.
        </p>
