<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">ინგლისური ელექტრონული წიგნის შეკვეთა</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            თქვენ ყიდულობთ ინგლისურ ელექტრონულ ვერსიას წიგნისა «Skin for Life» 2 ფორმატში: EPUB და KPF.
        </p>

        <p class="text-gray-700 dark:text-gray-300 mb-6 font-semibold">
            წარმატებული გადახდის შემდეგ წიგნის ფაილები გაიგზავნება თქვენს მიერ მითითებულ ელფოსტაზე.
        </p>

        <form action="{{ route_locale('ebook-en-order.store') }}" method="POST">
            @csrf
