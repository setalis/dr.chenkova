<x-layouts.main>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Замовлення англійської електронної книги</h1>

        <p class="text-gray-700 dark:text-gray-300 mb-6">
            Ви купуєте англійську електронну версію книги «Skin for Life» у 2 форматах: EPUB та KPF.
        </p>
