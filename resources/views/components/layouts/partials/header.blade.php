<header class="w-full px-4 md:px-10 py-4 absolute top-0 left-0 right-0 z-99 bg-white/50 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none">
    <nav class="flex items-center justify-between">
        <div class="logo">
            <a href="/" class="text-xl font-semibold text-gray-900 drop-shadow-[0_0_15px_rgba(255,255,255,0.9)]"><span class="text-teal-600">Dr.</span>Chenkova</a>
        </div>
        <div class="hidden md:flex items-center space-x-8 uppercase text-xs">
            <a href="{{ route('home') }}" class="text-gray-900 hover:text-gray-900 font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] hover:drop-shadow-[0_0_25px_rgba(255,255,255,1)] transition-all">Главная</a>
            <div class="relative group">
                ...
                <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <div class="py-1">
                        <a href="{{ route('lessons') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Обучение</a>
                        <a href="{{ route('webinar') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Запись вебинаров</a>
                    </div>
                </div>
            </div>
            <a href="https://pro-cosmetics.pro/" class="text-gray-900 hover:text-gray-900 font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] hover:drop-shadow-[0_0_25px_rgba(255,255,255,1)] transition-all">Косметика</a>
            <a href="{{ route('acne') }}" class="text-gray-900 hover:text-gray-900 font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] hover:drop-shadow-[0_0_25px_rgba(255,255,255,1)] transition-all">Об акне</a>
            <a href="{{ route('about') }}" class="text-gray-900 hover:text-gray-900 font-medium drop-shadow-[0_0_15px_rgba(255,255,255,0.9)] hover:drop-shadow-[0_0_25px_rgba(255,255,255,1)] transition-all">Обо мне</a>
        </div>
            ...
            <div class="flex flex-col space-y-4 mt-8">
                <div class="relative">
                    ...
                    <div class="hidden pl-4 space-y-2 mt-2">
                        <a href="{{ route('lessons') }}" class="block text-gray-600 hover:text-gray-900">Обучение</a>
                        <a href="{{ route('webinar') }}" class="block text-gray-600 hover:text-gray-900">Запись вебинаров</a>
                    </div>
                </div>
                <a href="https://pro-cosmetics.pro/" class="text-gray-600 hover:text-gray-900 text-lg">Косметика</a>
                <a href="{{ route('about') }}" class="text-gray-600 hover:text-gray-900 text-lg">Обо мне</a>
                <a href="{{ route('acne') }}" class="text-gray-600 hover:text-gray-900 text-lg">Об акне</a>
